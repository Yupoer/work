...
class QuizInterface:
    ...
    def __init__(self, quiz_brian: QuizBrain):
        ...
        self.yes_button = Button(image=self.yes_img, highlightthickness=0, command=self.true_press)
        self.yes_button.grid(row=2, column=0)

        self.no_img = PhotoImage(file="images/false.png")
        self.no_button = Button(image=self.no_img, highlightthickness=0, command=self.false_press)
